const data = {
  Customer: {
    ...
    tItem: 'customer_order_details__element-order-table-item-number-',
    tName: 'customer_order_details__element-order-table-name-',
    tQuantity: 'customer_order_details__element-order-table-quantity-',
    tPrice: 'customer_order_details__element-order-table-unit-price-',
    tTotal: 'customer_order_details__element-order-table-sub-total-',
  ...
  Seller: {
    ...
    tItem: 'seller_order_details__element-order-table-item-number-',
    tName: 'seller_order_detailsel__ement-order-table-name-',
    tQuantity: 'seller_order_details__element-order-table-quantity-',
    tPrice: 'seller_order_details__element-order-table-unit-price-',
    tTotal: 'seller_order_details__element-order-table-sub-total-',
